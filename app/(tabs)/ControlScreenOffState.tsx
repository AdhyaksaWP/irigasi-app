...
const ControlScreenOffState = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.controlScreenOffState}>
      <Image
        style={styles.controlScreenOffStateChild}
        contentFit="cover"
      ...
      <View style={[styles.turnedOffWrapper, styles.wrapperFlexBox]}>
        <Text style={[styles.turnedOff, styles.textTypo]}>TURNED OFF</Text>
      </View>
      <Image
        style={styles.controlScreenOffStateItem}
        contentFit="cover"
      ...
      >
        <Pressable
          onPress={() => navigation.navigate("ControlScreenOffState1")}
        >
          <Text style={[styles.data1, styles.textTypo]}>Data</Text>
        </Pressable>
      </Pressable>
...
export default ControlScreenOffState;
